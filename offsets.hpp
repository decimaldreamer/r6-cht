...
constexpr uintptr_t OFFSET_GAMEMANAGER_ENTITY = 0x8; 
constexpr uintptr_t OFFSET_ENTITY_ENTITYINFO = 0x28;
constexpr uintptr_t OFFSET_ENTITYINFO_MAINCOMPONENT = 0xD8; 
constexpr uintptr_t OFFSET_MAINCOMPONENT_CHILDCOMPONENT = 0x8; 
constexpr uintptr_t OFFSET_CHILDCOMPONENT_HEALTH_INT = 0x168; 
